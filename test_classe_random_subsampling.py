...
class TestRandomSubsampling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.random_subsampling = RandomSubsampling(self.k, self.K, self.dim_test_set)

    def test_random_subsampling_split(self):
        risultati_iterazioni = self.random_subsampling.random_subsampling_split(self.X, self.y)
    ...
    def test_evaluate(self):
        accuracy_media, error_rate_media, sensitivity_media, specificity_media, geometric_mean_media, confusion_matrix_iterazione = self.random_subsampling.evaluate(self.X, self.y)
